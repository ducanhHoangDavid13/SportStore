...
public class PhanLoaiController {
    ...
    /**
     * Tải trang Quản lý Phân Loại (Danh sách, Lọc, Tìm kiếm VÀ Modal)
     */
    @GetMapping
    public String hienThiTrang(Model model,
        ...
        model.addAttribute("phanLoaiPage", phanLoaiPage);
        ...
        // 4. Trả về file HTML theo cấu trúc của bạn (view/admin/phanLoai.html)
        return "view/admin/phanLoai";
    }
}